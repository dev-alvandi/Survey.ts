...
exports.login = exports.setAvatar = exports.register = exports.getUser = void 0;
...
const welcomeEmailTemplate_1 = __importDefault(require("../utils/welcomeEmailTemplate"));
require('dotenv').config({ path: `${__dirname}/../../.env` });
const SENDGRID_KEY_API = process.env.SENDGRID_KEY_API;
...
const register = (req, res, next) => {
    ...
    bcrypt_1.default
        ...
        const emailConfirmation = {
            ...
            html: (0, welcomeEmailTemplate_1.default)(newUser.name, FRONTEND_URL),
        };
